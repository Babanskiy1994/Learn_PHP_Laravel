...
Route::get('/fos', [\App\Http\Controllers\MailController::class, 'showContactForm'])->name('fos');
Route::post('/contact_form_process', [\App\Http\Controllers\MailController::class, 'contactForm'])->name('contact_form_process');
